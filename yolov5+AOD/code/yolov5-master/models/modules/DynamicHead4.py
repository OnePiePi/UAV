...
__all__ = ['Detect_dyhead4', 'Segment_dyhead4']
...
class Detect_dyhead4(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(self.nl):
            ...
            if not self.training:  # inference
                ...
                if isinstance(self, Segment_dyhead4):  # (boxes + masks)
...
class Segment_dyhead4(Detect_dyhead4):
    ...
    def __init__(self, nc=80, anchors=(), nm=32, npr=256, ch=(), inplace=True):
        ...
        self.detect = Detect_dyhead4.forward
